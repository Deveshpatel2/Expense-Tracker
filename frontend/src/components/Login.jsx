...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 login-container">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-4">
              <div className="relative group">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 transition-colors group-focus-within:text-primary-500" />
                <input
                  id="email"
                  name="email"
                  type="email"
              ...
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 transition-colors group-focus-within:text-primary-500" />
                <input
                  id="password"
                  name="password"
            ...
            <div className="flex items-center justify-end">
              <Link to="/forgot-password" className="text-[14px] font-medium text-[#6366f1] hover:text-[#4f46e5] hover:underline">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-2 bg-white text-slate-400 tracking-wider">Or continue with</span>
              </div>
            </div>
      ...
      <button className="fixed bottom-8 right-8 w-14 h-14 bg-[#6366f1] hover:bg-[#4f46e5] text-white rounded-full shadow-xl shadow-indigo-500/30 flex items-center justify-center transition-transform hover:scale-105 active:scale-95 z-20">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path><line x1="8" y1="10" x2="8.01" y2="10"></line><line x1="12" y1="10" x2="12.01" y2="10"></line><line x1="16" y1="10" x2="16.01" y2="10"></line></svg>
      </button>
    </div>
  );
};
